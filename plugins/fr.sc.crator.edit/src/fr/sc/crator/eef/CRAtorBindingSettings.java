 ...
 */
public class CRAtorBindingSettings extends EEFBindingSettingsImpl {
	...
	protected String getEditingModelPath() {
		return "platform:/plugin/fr.sc.crator.edit/model/crator.editingmodel";
	}
